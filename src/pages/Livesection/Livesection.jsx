        ...
        <>
            <div className="container text-center pt-0">
                <div className="row  px-5 mx-5 ">
                    ...
                    <div className="col-12 col-md-12 col-lg-4  bg-primary shadow">
                    ...
                    <div className="col-12 col-md-12 col-lg-4  shadow"style={{backgroundColor:'lightblue'}}>
                        <div className="row border text-center"style={{height:"120px"}}>
                    ...
                    <div className="col-12 col-md-12 col-lg-4  shadow bg-primary">
                        <div className="row border text-center"style={{height:"120px"}}>
